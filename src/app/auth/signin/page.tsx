        ...
        <div className="rounded-3xl border border-white/8 bg-white/[0.02] p-8 shadow-2xl shadow-black/60 backdrop-blur-sm">
          ...
          <div className="flex flex-col items-center gap-4 mb-8">
            ...
            <div className="text-center">
              <h1 className="text-xl font-bold text-white">
                Welcome to StudyMind<span className="text-brand-light"> AI</span>
              </h1>
          ...
          <div className="flex items-center gap-2.5 rounded-xl border border-brand/20 bg-brand/8 px-4 py-3 mb-6">
            ...
            <p className="text-sm text-slate-300">
              You&apos;ll receive <span className="text-brand-light font-semibold">1 free token</span> on signup
            </p>
          </div>
          ...
          >
            {isLoading ? (
              <svg className="w-5 h-5 animate-spin text-slate-500" viewBox="0 0 24 24" fill="none">
