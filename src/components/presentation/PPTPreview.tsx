      ...
      <div className="rounded-3xl border border-border bg-surface p-6 md:p-8 shadow-2xl shadow-black/40">
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
          <div className="flex-1 min-w-0">
            ...
            <h2 className="text-foreground font-bold text-xl leading-snug mb-2 break-words">
              {presentation.title}
            </h2>
            <p className="text-muted text-xs">
              {presentation.slides.length} slides &middot; Generated {date}{" "}
              &middot; <span className="text-muted">{fileName}</span>
            </p>
          </div>
      ...
      <div className="space-y-3">
        {presentation.slides.map((slide) => (
          <div
            ...
            className="rounded-2xl border border-border bg-surface p-5 shadow-lg shadow-black/20 hover:border-brand/20 transition-colors"
          >
            {/* Slide header */}
            ...
            {/* Divider */}
            <div className="border-t border-border mb-3 ml-9" />
